				    ...
				    <div class="page-team-single-box">
                     ...
                     <div class="team-member-about">
                        ...
                        <div class="team-member-list wow fadeInUp" data-wow-delay="0.4s">
                            <ul>
                                <li>
                                    ...
                                    To acquaint with the research process and to systematically educate students in designing the study, selecting appropriate methodology, and execution of data collection process.
                                </li>
                                <li>
                                 
                                    To impart skills in the areas of developing clinical and in vitro research projects, data analysis, and preparing and presenting findings at meetings that involve data summarization and statistical analysis.
                                </li>
                                <li>
                                
                                    To familiarize students in formulating the aim and objectives for evaluating clinical outcomes in orthopaedics.

                                </li>
                                <li>
                                    To improve expertise and skills in critically evaluating literature to assist in developing a research plan, interpretation of data, and implementation into clinical practice.
                        ...
                        <p class="wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            Interns/ Fellows will be tutored and mentored by multi-disciplinary team at many levels with whom we are associated with. Currently we are associated with some of the top medical and technological institutions including Government Medical College, Kozhikode. Kerala., GMC Ortho Hospital (Foundation), Kozhikode, Kerala., Omandurar Government Medical College, Chennai, Tamil Nadu., Yenepoya Medical college, Yenepoya university, Mangalore., National Institute of Technology (NIT) Kozhikode, Kerala., for the purpose of research and jointly working on multiple projects together.
                        ...
                        <div class="team-member-list wow fadeInUp" data-wow-delay="0.4s">
                            <ul>
                                <li>
                                    ...
                                    Orthopaedic research internship application form:

                                </li>
                                <li>
                                 
                                    Copy of your resume [Includes school (SSLC & Higher secondary), major and year of undergraduate graduation with GPA, major and year of postgraduation with GPA, any previous research experience including project title, purpose of the research, mentor/ institution, dates and role of the project.]
                                </li>
                                <li>
